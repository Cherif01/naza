    ...
    <div class="page-heading">
                ...
                <div class="form-row d-flex align-items-center justify-content-between flex-wrap mb-4 p-3 shadow">
                    <div class="form-group col-12 col-md-4">
                        <div class="me-2">
                            ...
                            <input type="date" id="date1" name="date1" class="form-control p-3 fs-4 fw-bold text-dark" required>
                        </div>
                    </div>
                    <div class="form-group col-12 col-md-4">
                        <div class="me-2">
                            <label for="date2">Date Fin</label>
                            <input type="date" id="date2" name="date2" class="form-control p-3 fs-4 fw-bold text-dark">
                        </div>
                    </div>
                    <div class="form-group col-12 col-md-4">
                        <div class="me-2">
                            <label for="option">Option</label>
                            <select id="option" name="option" disabled required class="form-control p-3 fs-4 fw-bold text-danger">
        ...
        <div class="card card-custom">
            <div class="card-header card-header-custom">
                <h3 class="card-title-custom">R&#233;sultats</h3>
            </div>
