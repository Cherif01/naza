                                        ...
                                        <?php foreach ($ListeTaux as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-outline-warning " data-bs-toggle="modal" data-bs-backdrop="false" data-bs-target="#backdrop-<?= $data['id'] ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-outline-danger " onclick="deleteAlert(<?= $data['id'] ?>, 'taux/delete-')">
                                                        <i class="fas fa-trash-alt"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                            <div class="modal fade text-left" id="backdrop-<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel4" aria-hidden="true">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="formulaire w-100">
                                                                    <div class="input-group mb-3">
                                                                        <input class="form-control form-control fw-bold w-100" required name="tauxJour" type="text" value="<?= $data['tauxJour'] ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <div class="modal-content">
                    <form action="" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="formulaire w-100">
                                <div class="input-group mb-3">
                                    <input class="form-control form-control fw-bold w-100" required name="tauxJour" type="text" placeholder="Entrer un taux">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
